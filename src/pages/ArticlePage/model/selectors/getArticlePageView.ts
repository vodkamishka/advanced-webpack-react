...
export const getArticlePageSort = (state: Pick<StateSchema, 'articlePage'>) => state.articlePage?.sort;
export const getArticlePageOrder = (state: Pick<StateSchema, 'articlePage'>) => state.articlePage?.order;
export const getArticlePageSearch = (state: Pick<StateSchema, 'articlePage'>) => state.articlePage?.search;
export const getArticlePageType = (state: Pick<StateSchema, 'articlePage'>) => state.articlePage?.type;
